...
public abstract class BPC_BUDGETBase extends com.cordys.cpc.bsf.busobject.StateBusObject
{
    ...
    public static ClassInfo _getClassInfo()//NOPMD framework ensures this is thread safe
    {
        ...
        {
            s_classInfo = newClassInfo(BPC_BUDGET.class);
            s_classInfo.setTableName("BPC_BUDGET");
    ...
    public BPC_BUDGETBase(BusObjectConfig config)
    {
        super(config);
    }
    ...
    public static com.laiyifen.bpc.core.BPC_BUDGET getBpcBudgetObject(double ID)
    {
        String queryText = "select * from \"BPC_BUDGET\" where \"ID\" = :ID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("ID", "BPC_BUDGET.ID", QueryObject.PARAM_DOUBLE, new Double(ID));//NOPMD
        query.setResultClass(BPC_BUDGET.class);
        return (BPC_BUDGET)query.getObject();
    }

    public static BusObjectIterator<com.laiyifen.bpc.core.BPC_BUDGET> getBpcBudgetObjects(double fromID, double toID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"BPC_BUDGET\" where \"ID\" between :fromID and :toID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromID", "BPC_BUDGET.ID", QueryObject.PARAM_DOUBLE, new Double(fromID));
        query.addParameter("toID", "BPC_BUDGET.ID", QueryObject.PARAM_DOUBLE, new Double(toID));
        query.setResultClass(BPC_BUDGET.class);
        query.setCursor(cursor);
        return query.getObjects();
    }

    public static BusObjectIterator<com.laiyifen.bpc.core.BPC_BUDGET> getBpcBudgetObjects(double fromID, double toID)
    {
        String queryText = "select * from \"BPC_BUDGET\" where \"ID\" between :fromID and :toID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromID", "BPC_BUDGET.ID", QueryObject.PARAM_DOUBLE, new Double(fromID));
    ...
    public static BusObjectIterator<com.laiyifen.bpc.core.BPC_BUDGET> getNextBpcBudgetObjects(double ID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"BPC_BUDGET\" where (\"ID\" > :ID) order by \"ID\" asc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("ID", "BPC_BUDGET.ID", QueryObject.PARAM_DOUBLE, new Double(ID));//NOPMD
        query.setResultClass(BPC_BUDGET.class);
        query.setCursor(cursor);
    ...
    public static BusObjectIterator<com.laiyifen.bpc.core.BPC_BUDGET> getPreviousBpcBudgetObjects(double ID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"BPC_BUDGET\" where (\"ID\" < :ID) order by \"ID\" desc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("ID", "BPC_BUDGET.ID", QueryObject.PARAM_DOUBLE, new Double(ID));//NOPMD
        query.setResultClass(BPC_BUDGET.class);
        query.setCursor(cursor);
