...
public class CordysDBConnectionManager
{
	static private CordysDBConnectionManager instance; // The single instance
	 ...
	 */
	static synchronized public CordysDBConnectionManager getInstance(String driverName, String url,
			String userName, String password, int readConnections)
	{
		if (instance == null)
		{
			instance = new CordysDBConnectionManager(driverName, url, userName, password,
					readConnections);
		}
		clients++;
	 ...
	 */
	private CordysDBConnectionManager(String driverName, String url, String userName, String password,
			int readConnections)
	{
