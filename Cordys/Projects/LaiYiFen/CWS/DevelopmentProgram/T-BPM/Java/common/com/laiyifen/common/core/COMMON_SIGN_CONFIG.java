...
protected void onBeforeInsert() {
	...
	public static BusObjectIterator<com.laiyifen.common.core.COMMON_SIGN_CONFIG> getUsersInfo(
			String processCode, String stepCode, String companyCode) {
		String queryText = "select * from COMMON_SIGN_CONFIG where PROCESS_CODE=:PROCESS_CODE and STEP_CODE=:STEP_CODE and COMPANY_CODE=:COMPANY_CODE";
		QueryObject query = new QueryObject(queryText);
		query.addParameter("PROCESS_CODE", "COMMON_SIGN_CONFIG.PROCESS_CODE",
				QueryObject.PARAM_STRING, processCode);
		query.addParameter("STEP_CODE", "COMMON_SIGN_CONFIG.STEP_CODE",
				QueryObject.PARAM_STRING, stepCode);
		query.addParameter("COMPANY_CODE", "COMMON_SIGN_CONFIG.COMPANY_CODE",
				QueryObject.PARAM_STRING, companyCode);

		query.setResultClass(COMMON_SIGN_CONFIG.class);

		return query.getObjects();
	}
public static BusObjectIterator<com.laiyifen.common.core.COMMON_SIGN_CONFIG> getMyCOMMON_SIGN_CONFIG(String processname, String stepname)
    {
