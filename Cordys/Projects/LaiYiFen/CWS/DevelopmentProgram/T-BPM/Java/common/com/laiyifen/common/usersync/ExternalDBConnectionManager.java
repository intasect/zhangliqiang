...
{
	static private ExternalDBConnectionManager instance; // The single instance
	 ...
	 */
	static synchronized public ExternalDBConnectionManager getInstance(String driverName, String url,
			String userName, String password, int readConnections)
	{
		if (instance == null)
		{
			instance = new ExternalDBConnectionManager(driverName, url, userName, password,
					readConnections);
		}
		clients++;
	 ...
	 */
	private ExternalDBConnectionManager(String driverName, String url, String userName, String password,
			int readConnections)
	{
