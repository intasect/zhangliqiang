...
public abstract class SHOP_EQUACCBase extends com.cordys.cpc.bsf.busobject.StateBusObject
{
    ...
    public final static String ATTR_ELECT_SCALES_NO = "ELECT_SCALES_NO";
    public final static String ATTR_ISUSE_BALANCE = "ISUSE_BALANCE";
    ...
    public static ClassInfo _getClassInfo()//NOPMD framework ensures this is thread safe
    {
        ...
        {
            s_classInfo = newClassInfo(SHOP_EQUACC.class);
            s_classInfo.setTableName("SHOP_EQUACC");
            ...
            {
                AttributeInfo ai = new AttributeInfo(ATTR_ELECT_SCALES_NO);
                ai.setJavaName(ATTR_ELECT_SCALES_NO);
                ai.setColumnName(ATTR_ELECT_SCALES_NO);
                ai.setAttributeClass(double.class);
                NumberValidator v = new NumberValidator(ATTR_ELECT_SCALES_NO);
                ai.addConstraintHandler(v);
                s_classInfo.addAttributeInfo(ai);
            }
            {
                AttributeInfo ai = new AttributeInfo(ATTR_ISUSE_BALANCE);
                ai.setJavaName(ATTR_ISUSE_BALANCE);
                ai.setColumnName(ATTR_ISUSE_BALANCE);
                ai.setAttributeClass(String.class);
                StringValidator v = new StringValidator(ATTR_ISUSE_BALANCE);
                v.setMaxLength(1);
                ai.addConstraintHandler(v);
                s_classInfo.addAttributeInfo(ai);
            }
    ...
    public SHOP_EQUACCBase(BusObjectConfig config)
    {
        super(config);
    }
    ...
    public double getELECT_SCALES_NO()
    {
        return getDoubleProperty(ATTR_ELECT_SCALES_NO);
    }

    public void setELECT_SCALES_NO(double value)
    {
        setProperty(ATTR_ELECT_SCALES_NO, value, 0);
    }

    public String getISUSE_BALANCE()
    {
        return getStringProperty(ATTR_ISUSE_BALANCE);
    }

    public void setISUSE_BALANCE(String value)
    {
        setProperty(ATTR_ISUSE_BALANCE, value, 0);
    }
    ...
    public static BusObjectIterator<com.laiyifen.shop.SHOP_EQUACC> getNextShopEquaccObjects(String FORM_ID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"SHOP_EQUACC\" where (\"FORM_ID\" > :FORM_ID) order by \"FORM_ID\" asc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("FORM_ID", "SHOP_EQUACC.FORM_ID", QueryObject.PARAM_STRING, FORM_ID);//NOPMD
        query.setResultClass(SHOP_EQUACC.class);
        query.setCursor(cursor);
        return query.getObjects();
    }

    public static BusObjectIterator<com.laiyifen.shop.SHOP_EQUACC> getPreviousShopEquaccObjects(String FORM_ID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"SHOP_EQUACC\" where (\"FORM_ID\" < :FORM_ID) order by \"FORM_ID\" desc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("FORM_ID", "SHOP_EQUACC.FORM_ID", QueryObject.PARAM_STRING, FORM_ID);//NOPMD
        query.setResultClass(SHOP_EQUACC.class);
        query.setCursor(cursor);
    ...
    public static com.laiyifen.shop.SHOP_EQUACC getShopEquaccObject(String FORM_ID)
    {
        String queryText = "select * from \"SHOP_EQUACC\" where \"FORM_ID\" = :FORM_ID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("FORM_ID", "SHOP_EQUACC.FORM_ID", QueryObject.PARAM_STRING, FORM_ID);//NOPMD
        query.setResultClass(SHOP_EQUACC.class);
        return (SHOP_EQUACC)query.getObject();
    }


    public static BusObjectIterator<com.laiyifen.shop.SHOP_EQUACC> getShopEquaccObjects(String fromFORM_ID, String toFORM_ID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"SHOP_EQUACC\" where \"FORM_ID\" between :fromFORM_ID and :toFORM_ID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromFORM_ID", "SHOP_EQUACC.FORM_ID", QueryObject.PARAM_STRING, fromFORM_ID);
        query.addParameter("toFORM_ID", "SHOP_EQUACC.FORM_ID", QueryObject.PARAM_STRING, toFORM_ID);
        query.setResultClass(SHOP_EQUACC.class);
        query.setCursor(cursor);
        return query.getObjects();
    }

    public static BusObjectIterator<com.laiyifen.shop.SHOP_EQUACC> getShopEquaccObjects(String fromFORM_ID, String toFORM_ID)
    {
        String queryText = "select * from \"SHOP_EQUACC\" where \"FORM_ID\" between :fromFORM_ID and :toFORM_ID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromFORM_ID", "SHOP_EQUACC.FORM_ID", QueryObject.PARAM_STRING, fromFORM_ID);
