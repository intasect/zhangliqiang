...
public abstract class CompositeShopTransPosBase extends com.cordys.cpc.bsf.busobject.CustomBusObject
{
    ...
    private final static String REL_SHOP_TRANSFER_POS = "AGGR:SHOP_TRANSFER_POS";
    private static ClassInfo s_classInfo = null;
    public static ClassInfo _getClassInfo()//NOPMD framework ensures this is thread safe
    {
        if ( s_classInfo == null )//NOPMD
        {
            s_classInfo = newClassInfo(CompositeShopTransPos.class);
            ...
            {
                RelationInfo_Composite ri = new RelationInfo_Composite(REL_SHOP_TRANSFER_POS);
                ri.setName("SHOP_TRANSFER_POS");
                ri.setMultiOcc(false);
                ri.setRelatedClass(com.laiyifen.shop.SHOP_TRANSFER_POS.class);
                s_classInfo.addRelationInfo(ri);
            }
        }
        return s_classInfo;
    ...
    public CompositeShopTransPosBase(BusObjectConfig config)
    {
        super(config);
    }
    ...
    public SHOP_TRANSFER_POS getSHOP_TRANSFER_POSObject()
    {
        return (SHOP_TRANSFER_POS)getSingleRelationObject(REL_SHOP_TRANSFER_POS);
    }

    public SHOP_TRANSFER_POS setSHOP_TRANSFER_POSObject(SHOP_TRANSFER_POS a_SHOP_TRANSFER_POS)
    {
        return(SHOP_TRANSFER_POS)_getSingleRelation(REL_SHOP_TRANSFER_POS, true).setLocalObject(a_SHOP_TRANSFER_POS);
    }
