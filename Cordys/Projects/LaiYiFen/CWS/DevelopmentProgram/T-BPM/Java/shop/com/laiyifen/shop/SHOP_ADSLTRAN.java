...
public class SHOP_ADSLTRAN extends SHOP_ADSLTRANBase
{
    private User userObj = null;
    public SHOP_ADSLTRAN()
    {
        this((BusObjectConfig)null);
    }

    public SHOP_ADSLTRAN(BusObjectConfig config)
    {

        super(config);
    }

    public static com.laiyifen.shop.SHOP_ADSLTRAN getShopAdsltranObjectByShopId(String shopId)
    {
        StringBuffer queryText = new StringBuffer();
    	QueryObject query = null;
    	
    	queryText.append("select * from SHOP_ADSLTRAN where \"SHOP_ID\" = :SHOP_ID ");
    	
    	query = new QueryObject(queryText.toString());
    	query.addParameter("SHOP_ID", "SHOP_ADSLTRAN.SHOP_ID", QueryObject.PARAM_STRING, shopId);
