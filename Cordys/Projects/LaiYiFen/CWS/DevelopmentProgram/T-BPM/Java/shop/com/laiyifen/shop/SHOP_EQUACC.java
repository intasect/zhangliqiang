...
public class SHOP_EQUACC extends SHOP_EQUACCBase
{
    ...
    public SHOP_EQUACC(BusObjectConfig config)
    {
        super(config);
    }

    public static com.laiyifen.shop.SHOP_EQUACC getShopEquaccObjectByShopId(String shopId)
    {
    	String queryText = "select * from \"SHOP_EQUACC\" where \"SHOP_ID\" = :SHOP_ID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("SHOP_ID", "SHOP_EQUACC.SHOP_ID", QueryObject.PARAM_STRING, shopId);
