...
public class SHOP_MASTER_FINDEPT extends SHOP_MASTER_FINDEPTBase
{
	private User userObj = null;
    public SHOP_MASTER_FINDEPT()
    {
        this((BusObjectConfig)null);
    }

    public SHOP_MASTER_FINDEPT(BusObjectConfig config)
    {
        super(config);
    }

    public static com.laiyifen.shop.SHOP_MASTER_FINDEPT getShopMasterFindeptByShopId(String shopId)
    {
    	StringBuffer queryText = new StringBuffer();
    	QueryObject query = null;
    	
    	queryText.append("select * from SHOP_MASTER_FINDEPT where \"SHOP_ID\" = :SHOP_ID ");
    	
    	query = new QueryObject(queryText.toString());
    	query.addParameter("SHOP_ID", "SHOP_MASTER_FINDEPT.SHOP_ID", QueryObject.PARAM_STRING, shopId);
