...
public class SHOP_MASTER_ENGDEPT extends SHOP_MASTER_ENGDEPTBase
{
	private User userObj = null;
    public SHOP_MASTER_ENGDEPT()
    {
        this((BusObjectConfig)null);
    }

    public SHOP_MASTER_ENGDEPT(BusObjectConfig config)
    {
        super(config);
    }

    public static com.laiyifen.shop.SHOP_MASTER_ENGDEPT getShopMasterEngdeptObjectByShopId(String shopId)
    {
    	StringBuffer queryText = new StringBuffer();
    	QueryObject query = null;
    	
    	queryText.append("select * from SHOP_MASTER_ENGDEPT where \"SHOP_ID\" = :SHOP_ID ");
    	
    	query = new QueryObject(queryText.toString());
    	query.addParameter("SHOP_ID", "SHOP_MASTER_ENGDEPT.SHOP_ID", QueryObject.PARAM_STRING, shopId);
