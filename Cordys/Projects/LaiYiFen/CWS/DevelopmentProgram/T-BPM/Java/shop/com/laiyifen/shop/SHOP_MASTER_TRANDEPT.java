...
public class SHOP_MASTER_TRANDEPT extends SHOP_MASTER_TRANDEPTBase
{
	private User userObj = null;
    public SHOP_MASTER_TRANDEPT()
    {
        this((BusObjectConfig)null);
    }

    public SHOP_MASTER_TRANDEPT(BusObjectConfig config)
    {
        super(config);
    }

    public static com.laiyifen.shop.SHOP_MASTER_TRANDEPT getShopMasterTrandeptByShopId(String shopId)
    {
    	StringBuffer queryText = new StringBuffer();
    	QueryObject query = null;
    	
    	queryText.append("select * from SHOP_MASTER_TRANDEPT where \"SHOP_ID\" = :SHOP_ID ");
    	
    	query = new QueryObject(queryText.toString());
    	query.addParameter("SHOP_ID", "SHOP_MASTER_TRANDEPT.SHOP_ID", QueryObject.PARAM_STRING, shopId);
