...
public abstract class SHOP_MATERIAL_CONFIGURATIONBase extends com.cordys.cpc.bsf.busobject.StateBusObject
{
    ...
    public static ClassInfo _getClassInfo()//NOPMD framework ensures this is thread safe
    {
        ...
        {
            s_classInfo = newClassInfo(SHOP_MATERIAL_CONFIGURATION.class);
            s_classInfo.setTableName("SHOP_MATERIAL_CONFIGURATION");
    ...
    public SHOP_MATERIAL_CONFIGURATIONBase(BusObjectConfig config)
    {
        super(config);
    }
    ...
    public static BusObjectIterator<com.laiyifen.shop.SHOP_MATERIAL_CONFIGURATION> getNextShopMaterialConfigurationObjects(String ID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"SHOP_MATERIAL_CONFIGURATION\" where (\"ID\" > :ID) order by \"ID\" asc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("ID", "SHOP_MATERIAL_CONFIGURATION.ID", QueryObject.PARAM_STRING, ID);//NOPMD
        query.setResultClass(SHOP_MATERIAL_CONFIGURATION.class);
        query.setCursor(cursor);
        return query.getObjects();
    }

    public static BusObjectIterator<com.laiyifen.shop.SHOP_MATERIAL_CONFIGURATION> getPreviousShopMaterialConfigurationObjects(String ID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"SHOP_MATERIAL_CONFIGURATION\" where (\"ID\" < :ID) order by \"ID\" desc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("ID", "SHOP_MATERIAL_CONFIGURATION.ID", QueryObject.PARAM_STRING, ID);//NOPMD
        query.setResultClass(SHOP_MATERIAL_CONFIGURATION.class);
        query.setCursor(cursor);
    ...
    public static com.laiyifen.shop.SHOP_MATERIAL_CONFIGURATION getShopMaterialConfigurationObject(String ID)
    {
        String queryText = "select * from \"SHOP_MATERIAL_CONFIGURATION\" where \"ID\" = :ID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("ID", "SHOP_MATERIAL_CONFIGURATION.ID", QueryObject.PARAM_STRING, ID);//NOPMD
        query.setResultClass(SHOP_MATERIAL_CONFIGURATION.class);
        return (SHOP_MATERIAL_CONFIGURATION)query.getObject();
    }

    public static BusObjectIterator<com.laiyifen.shop.SHOP_MATERIAL_CONFIGURATION> getShopMaterialConfigurationObjects(String fromID, String toID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"SHOP_MATERIAL_CONFIGURATION\" where \"ID\" between :fromID and :toID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromID", "SHOP_MATERIAL_CONFIGURATION.ID", QueryObject.PARAM_STRING, fromID);
        query.addParameter("toID", "SHOP_MATERIAL_CONFIGURATION.ID", QueryObject.PARAM_STRING, toID);
        query.setResultClass(SHOP_MATERIAL_CONFIGURATION.class);
        query.setCursor(cursor);
        return query.getObjects();
    }

    public static BusObjectIterator<com.laiyifen.shop.SHOP_MATERIAL_CONFIGURATION> getShopMaterialConfigurationObjects(String fromID, String toID)
    {
        String queryText = "select * from \"SHOP_MATERIAL_CONFIGURATION\" where \"ID\" between :fromID and :toID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromID", "SHOP_MATERIAL_CONFIGURATION.ID", QueryObject.PARAM_STRING, fromID);
