...
public class SHOP_TRANSFER_POS extends SHOP_TRANSFER_POSBase
{
	private User userObj = null;
    public SHOP_TRANSFER_POS()
    {
        this((BusObjectConfig)null);
    }

    public SHOP_TRANSFER_POS(BusObjectConfig config)
    {
        super(config);
    }

    public static com.laiyifen.shop.SHOP_TRANSFER_POS getShopTransPosByShopId(String shopId)
    {
    	StringBuffer queryText = new StringBuffer();
    	QueryObject query = null;
    	
    	queryText.append("select * from SHOP_TRANSFER_POS where \"SHOP_ID\" = :SHOP_ID ");
    	
    	query = new QueryObject(queryText.toString());
    	query.addParameter("SHOP_ID", "SHOP_TRANSFER_POS.SHOP_ID", QueryObject.PARAM_STRING, shopId);
