...
public abstract class SHOP_TRANSFER_POSBase extends com.cordys.cpc.bsf.busobject.StateBusObject
{
    ...
    public final static String ATTR_POS_TERMINALNO = "POS_TERMINALNO";
    ...
    public static ClassInfo _getClassInfo()//NOPMD framework ensures this is thread safe
    {
        ...
        {
            s_classInfo = newClassInfo(SHOP_TRANSFER_POS.class);
            s_classInfo.setTableName("SHOP_TRANSFER_POS");
            ...
            {
                AttributeInfo ai = new AttributeInfo(ATTR_POS_TERMINALNO);
                ai.setJavaName(ATTR_POS_TERMINALNO);
                ai.setColumnName(ATTR_POS_TERMINALNO);
                ai.setAttributeClass(String.class);
                StringValidator v = new StringValidator(ATTR_POS_TERMINALNO);
                v.setMaxLength(8);
                ai.addConstraintHandler(v);
                s_classInfo.addAttributeInfo(ai);
            }
    ...
    public SHOP_TRANSFER_POSBase(BusObjectConfig config)
    {
        super(config);
    }
    ...
    public String getPOS_TERMINALNO()
    {
        return getStringProperty(ATTR_POS_TERMINALNO);
    }

    public void setPOS_TERMINALNO(String value)
    {
        setProperty(ATTR_POS_TERMINALNO, value, 0);
    }
    ...
    public static BusObjectIterator<com.laiyifen.shop.SHOP_TRANSFER_POS> getNextShopTransferPosObjects(String FORM_ID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"SHOP_TRANSFER_POS\" where (\"FORM_ID\" > :FORM_ID) order by \"FORM_ID\" asc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("FORM_ID", "SHOP_TRANSFER_POS.FORM_ID", QueryObject.PARAM_STRING, FORM_ID);//NOPMD
        query.setResultClass(SHOP_TRANSFER_POS.class);
        query.setCursor(cursor);
        return query.getObjects();
    }

    public static BusObjectIterator<com.laiyifen.shop.SHOP_TRANSFER_POS> getPreviousShopTransferPosObjects(String FORM_ID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"SHOP_TRANSFER_POS\" where (\"FORM_ID\" < :FORM_ID) order by \"FORM_ID\" desc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("FORM_ID", "SHOP_TRANSFER_POS.FORM_ID", QueryObject.PARAM_STRING, FORM_ID);//NOPMD
        query.setResultClass(SHOP_TRANSFER_POS.class);
        query.setCursor(cursor);
    ...
    public static com.laiyifen.shop.SHOP_TRANSFER_POS getShopTransferPosObject(String FORM_ID)
    {
        String queryText = "select * from \"SHOP_TRANSFER_POS\" where \"FORM_ID\" = :FORM_ID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("FORM_ID", "SHOP_TRANSFER_POS.FORM_ID", QueryObject.PARAM_STRING, FORM_ID);//NOPMD
        query.setResultClass(SHOP_TRANSFER_POS.class);
        return (SHOP_TRANSFER_POS)query.getObject();
    }

    public static BusObjectIterator<com.laiyifen.shop.SHOP_TRANSFER_POS> getShopTransferPosObjects(String fromFORM_ID, String toFORM_ID, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"SHOP_TRANSFER_POS\" where \"FORM_ID\" between :fromFORM_ID and :toFORM_ID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromFORM_ID", "SHOP_TRANSFER_POS.FORM_ID", QueryObject.PARAM_STRING, fromFORM_ID);
        query.addParameter("toFORM_ID", "SHOP_TRANSFER_POS.FORM_ID", QueryObject.PARAM_STRING, toFORM_ID);
        query.setResultClass(SHOP_TRANSFER_POS.class);
        query.setCursor(cursor);
        return query.getObjects();
    }

    public static BusObjectIterator<com.laiyifen.shop.SHOP_TRANSFER_POS> getShopTransferPosObjects(String fromFORM_ID, String toFORM_ID)
    {
        String queryText = "select * from \"SHOP_TRANSFER_POS\" where \"FORM_ID\" between :fromFORM_ID and :toFORM_ID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromFORM_ID", "SHOP_TRANSFER_POS.FORM_ID", QueryObject.PARAM_STRING, fromFORM_ID);
